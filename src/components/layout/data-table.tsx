...
function getColumns(
  ...
  return [
    ...
    },
    {
      accessorKey: "target",
      header: () => (
        <div className="w-full text-right">{t("table.target")}</div>
      ),
      cell: ({ row }) => (
        <form
          onSubmit={(e) => {
    ...
    },
    {
      ...
      cell: ({ row }) => {
        const placeholder = t("table.assignReviewer");
        const isAssigned =
          row.original.reviewer !== placeholder &&
        ...
        return (
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-32">
              ...
              <DropdownMenuItem>{t("table.makeACopy")}</DropdownMenuItem>
      ...
      <div className="flex items-center justify-between px-4 lg:px-6">
        ...
        <Select defaultValue="outline">
          <SelectTrigger
            ...
            id="view-selector"
          >
            <SelectValue placeholder={t("table.selectAView")} />
          </SelectTrigger>
          <SelectContent>
            <SelectItem value="outline">{t("table.outline")}</SelectItem>
            <SelectItem value="past-performance">
              {t("table.pastPerformance")}
            </SelectItem>
            <SelectItem value="key-personnel">
              {t("table.keyPersonnel")}
            </SelectItem>
            <SelectItem value="focus-documents">
              {t("table.focusDocuments")}
            </SelectItem>
          </SelectContent>
        </Select>
        <TabsList className="**:data-[slot=badge]:bg-muted-foreground/30 hidden **:data-[slot=badge]:size-5 **:data-[slot=badge]:rounded-full **:data-[slot=badge]:px-1 @4xl/main:flex">
          ...
          <TabsTrigger value="past-performance">
            {t("table.pastPerformance")} <Badge variant="secondary">3</Badge>
          </TabsTrigger>
          <TabsTrigger value="key-personnel">
            {t("table.keyPersonnel")} <Badge variant="secondary">2</Badge>
          </TabsTrigger>
    ...
    <Drawer direction={isMobile ? "bottom" : "right"}>
      ...
      <DrawerContent>
        <DrawerHeader className="gap-1">
          ...
          <DrawerDescription>{t("table.showingVisitors")}</DrawerDescription>
        </DrawerHeader>
        <div className="flex flex-col gap-4 overflow-y-auto px-4 text-sm">
            ...
            <>
              ...
              <div className="grid gap-2">
                <div className="flex gap-2 leading-none font-medium">
                  {t("table.trendingUp")} <IconTrendingUp className="size-4" />
                </div>
                <div className="text-muted-foreground">
                  {t("table.showingVisitorsLong")}
                </div>
              </div>
              <Separator />
            </>
          ...
          <form className="flex flex-col gap-4">
            <div className="flex flex-col gap-3">
              <Label htmlFor="header">{t("table.header")}</Label>
                ...
                <Select defaultValue={item.type}>
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="Executive Summary">
                      {t("table.typeExecSummary")}
                    </SelectItem>
                    <SelectItem value="Technical Approach">
                      {t("table.typeTechApproach")}
                    </SelectItem>
                    <SelectItem value="Design">
                      {t("table.typeDesign")}
                    </SelectItem>
                    <SelectItem value="Capabilities">
                      {t("table.typeCapabilities")}
                    </SelectItem>
                    <SelectItem value="Focus Documents">
                      {t("table.typeFocusDocs")}
                    </SelectItem>
                    <SelectItem value="Narrative">
                      {t("table.typeNarrative")}
                    </SelectItem>
                    <SelectItem value="Cover Page">
                      {t("table.typeCoverPage")}
                    </SelectItem>
                  </SelectContent>
                </Select>
              </div>
                ...
                <Select defaultValue={item.status}>
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="In Progress">
                      {t("table.statusInProgress")}
                    </SelectItem>
                    <SelectItem value="Not Started">
                      {t("table.statusNotStarted")}
                    </SelectItem>
                  </SelectContent>
                </Select>
              </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="flex flex-col gap-3">
                <Label htmlFor="target">{t("table.target")}</Label>
                <Input id="target" defaultValue={item.target} />
              </div>
              <div className="flex flex-col gap-3">
                <Label htmlFor="limit">{t("table.limit")}</Label>
                <Input id="limit" defaultValue={item.limit} />
              </div>
            </div>
            <div className="flex flex-col gap-3">
              <Label htmlFor="reviewer">{t("table.reviewer")}</Label>
        ...
        <DrawerFooter>
          ...
          <DrawerClose asChild>
            <Button variant="outline">{t("table.done")}</Button>
          </DrawerClose>
        </DrawerFooter>
      </DrawerContent>
    </Drawer>
