...
const getChartConfig = (t: (key: string) => string): ChartConfig => ({
  visitors: {
...
export function ChartAreaInteractive() {
  ...
  const currentLang = i18n.language || i18next.language || "en";
        ...
        <CardAction>
          ...
          <Select value={timeRange} onValueChange={setTimeRange}>
            <SelectTrigger
              ...
              size="sm"
              aria-label={t("chart.selectValue")}
            >
