...
import { IconLayersSubtract, IconPlus, IconTrash } from "@tabler/icons-react";
                      ...
                      <Controller
                        ...
                        render={({ field }) => (
                          <ServicePicker
                            ...
                            emptyMessage={t("manageServices.form.parentEmpty")}
              ...
              <div className="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
                ...
                <div className="w-full sm:w-72">
                  <ServicePicker
                    ...
                    emptyMessage={t("manageServices.form.submodelPickerEmpty")}
                    noSearchResultsMessage={t(
